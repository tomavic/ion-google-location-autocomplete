(function () {
    ...
    angular
        ...
        .directive('googleLocationAutocomplete', directive);

    directive.$inject = ['$ionicModal', 'googleLocationAutocompleteService'];

    function directive($ionicModal, googleLocationAutocompleteService) {
        ...
        function link($scope, element) {
            ...
            var template = [
                ...
                '</ion-list>',
                '<div class="padding">',
                '<img src="https://developers.google.com/maps/documentation/places/images/powered-by-google-on-white.png" style="margin-left: 5px" alt="Powered by Google" />',
                '</div>',
                '</ion-content>',
                '</ion-modal-view>'
            ].join('')
            ...
            $scope.choosePlace = function (place) {
                googleLocationAutocompleteService.getDetails(place.place_id).then(function (location) {
            ...
            $scope.$watch('search.query', function (newValue) {
                if (newValue) {
                    googleLocationAutocompleteService.searchAddress(newValue, $scope.countryCode).then(function (result) {
